...
// Copy Last 2 Treasures to Beginning
loot.copyWithin(0, loot.length-2); // Syntax: array.copyWithin(copy_to_index, from_pos, to_pos)
console.log("Copied Loot: \n", loot);

// Fill Last 3 Positions with "unknown"
loot.fill("unknown", loot.length-3);  // Syntax: array.fill(fill_with_this, from_pos, to_pos)
